  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <div className="group relative bg-black mx-auto flex items-center justify-center gap-2 rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f] ">
          <span
