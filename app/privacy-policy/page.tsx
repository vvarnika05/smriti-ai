export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 pt-24 pb-20">
      ...
      <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">3. Data Security</h2>
      <p className="text-gray-700 dark:text-gray-300 mb-6">
        We implement appropriate security measures to protect your data from unauthorized access, disclosure, or loss.
      </p>

      <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">4. Your Rights</h2>
      <p className="text-gray-700 dark:text-gray-300 mb-6">
      ...
      <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">5. Contact Us</h2>
